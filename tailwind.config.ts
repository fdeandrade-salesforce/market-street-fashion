...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // ============================================================================
      fontSize: {
        'display': ['4rem', { lineHeight: '1.1', fontWeight: '600', letterSpacing: '-0.01em' }],
        'h1': ['3rem', { lineHeight: '1.15', fontWeight: '600', letterSpacing: '-0.01em' }],
        'h2': ['2.25rem', { lineHeight: '1.2', fontWeight: '600', letterSpacing: '0' }],
        'h3': ['1.875rem', { lineHeight: '1.25', fontWeight: '500', letterSpacing: '0' }],
        'h4': ['1.5rem', { lineHeight: '1.3', fontWeight: '500', letterSpacing: '0' }],
        'h5': ['1.25rem', { lineHeight: '1.4', fontWeight: '500', letterSpacing: '0.01em' }],
        'h6': ['1rem', { lineHeight: '1.4', fontWeight: '500', letterSpacing: '0.01em' }],
        ...
        'caption': ['0.75rem', { lineHeight: '1.4', fontWeight: '400', letterSpacing: '0.03em' }],
        'nav': ['0.875rem', { lineHeight: '1.4', fontWeight: '500', letterSpacing: '0.05em' }],
