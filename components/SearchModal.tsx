...
export default function SearchModal({ isOpen, onClose, onOpenAgent }: SearchModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col">
      ...
      {/* Modal Content */}
      <div className="relative bg-white w-full h-full md:h-auto md:max-h-[80vh] md:overflow-y-auto shadow-2xl flex flex-col md:mt-0">
        <div className="layout-commerce flex-1 flex flex-col">
          {/* Search Header */}
