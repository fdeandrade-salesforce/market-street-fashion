              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="aspect-square bg-brand-gray-100 rounded-lg overflow-hidden">
                  <video
                    ...
                    playsInline
                  >
                    <source src="/images/products/mens/video-120.mp4" type="video/mp4" />
                  </video>
                </div>
              </div>
            </div>
            ...
            <div className="w-full layout-commerce">
              <div className="relative aspect-video bg-brand-gray-100 rounded-lg overflow-hidden shadow-sm">
                <video
                  ...
                  preload="metadata"
                >
                  <source src="/images/products/womens/video-220.mp4" type="video/mp4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              <div>
                <div className="aspect-square bg-brand-gray-100 rounded-lg mb-6 overflow-hidden">
                  <img
                    src="/images/products/womens/Wool Blend Coat Navy 01.png"
                    alt="Our Vision"
                    className="w-full h-full object-cover"
                  />
                </div>
              ...
              <div>
                <div className="aspect-square bg-brand-gray-100 rounded-lg mb-6 overflow-hidden">
                  <img
                    src="/images/products/mens/Oxford Shirt White 01.png"
                    alt="Why We Exist"
                    className="w-full h-full object-cover"
                  />
                </div>
          ...
          <section className="mb-16 md:mb-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="aspect-square bg-brand-gray-100 rounded-lg overflow-hidden order-2 lg:order-1">
                <img
                  src="/images/products/womens/Silk Midi Dress Pink 01.png"
